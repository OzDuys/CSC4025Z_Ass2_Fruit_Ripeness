...
\graphicspath{{./}{training notebooks/cnn/}{training notebooks/Baseline Algorithms/knn/}{training notebooks/Baseline Algorithms/hog/}{results/40_epochs/}{results/figures/}}
...
\begin{figure}[H]
  \centering
  \img[width=0.4\linewidth]{baseline_knn_k_tuning.png}
...
\begin{figure}[H]
  ...
  \begin{subfigure}{0.48\linewidth}
    \centering
    \img[width=\linewidth]{val_macro_f1_for_each_arch_in_training.png}
...
\begin{figure}[H]
  \centering
  \img[width=0.7\linewidth]{param_importance_basic_cnn.png}
...
\begin{figure}[H]
  \centering
  \img[width=0.8\linewidth]{results/figures/roc_sweep.png}
...
\textbf{Error patterns:} Confusions are expected between adjacent ripeness stages (e.g., ripe vs. slightly unripe/rotting). We summarise this with the aggregated confusion matrix (Figure~\ref{fig:confusion_matrix_all_hyperparam_runs}) and will add a classification report for the selected model.\\
...
See \texttt{README.md} for environment setup and dataset download instructions. Notebooks under \texttt{training notebooks/} reproduce baselines and the CNN experiments;\\ \texttt{training notebooks/cnn/hyperparam\_tuning/} contains the W\&B hyper-parameter sweep setup and analysis. Final test predictions and the best checkpoint for the selected model will be included in the submission package.
